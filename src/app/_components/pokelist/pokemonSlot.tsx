...
export default function PokemonSlot({ pokemon }: PokemonSlotProps) {
  ...
  return <Link href={`/pokemon/${pokemon.id}`}>
    <section className="cursor-pointer group w-100 relative flex items-center gap-4 overflow-visible rounded-full bg-white p-4 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md hover:ring-2 hover:ring-blue-400">
